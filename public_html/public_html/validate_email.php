<?php
	if(isset($_GET['v'])){
		...
		$vdb = $row['key'];
		if($vget != $vdb){
			echo "<script type='text/javascript'> alert('There was a problem with verification.'); window.location.href = 'http://www.castleblackgaming.com/index.php'; </script>";
			exit();
		}
		$query = "UPDATE user SET verified=1 WHERE id=" . $iget;
		mysqli_query($con, $query);
		echo "<script type='text/javascript'> alert('Thank you! You may log in now.'); window.location.href = 'http://www.castleblackgaming.com/index.php'; </script>";
	}
   ...
   <span id='body_style' style='padding:15px; display:block'> 
	...
	<p>
		Please verify your email by clicking <a href='http://www.castleblackgaming.com/validate_email.php?v=".$verification."&id=".$id."'>HERE</a>
		
	</p>
	 <p> Thanks,</p>
	 <p> CBG Dev Team </p>
	 <p> <img src ='http://www.castleblackgaming.com/images/logo.jpg' width='195' height='75' alt='Logo'></p>
	 </span>
	</body>
	</html>";
...
<div id="header">
  <div id="header_content-container">
    <div id="header-logo"><a href="http://www.castleblackgaming.com/index.php"><img src="images/logo.png" width="184" height="91" /></a></div>
  </div>
</div>
